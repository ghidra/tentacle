...
$setup=$mysql->table_exists('tentacle_users');//check to see if tentacle has been set up before.
if(!$setup){//if we have not been set up before, fill out the nessisary information to proceed
	...
	html_head('tentacle password setup');
	echo '<div style="width:200px;margin-left:auto;margin-right:auto;margin-top:16px">You are new to Tentacle, and have not set up a user.';
	echo ' Please take the time now to enter a user name and password so that you can have access to';
	echo ' the Tentacle interface.</div><br>';
